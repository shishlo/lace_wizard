...
sns_linac.xml         - design sns linac with SCL RF up to SCL:23d. 
                        The position of BPMs are the centers of the strip 
                        line electrodes.
                        
sns_sts_linac.xml     - design secon-target-station sns linac. It has all
                        SCL cavities up to SCL:32d. The BPM positions are
                        at the centers of strip lines electrodes as in 
                        sns_linac.xml
                        
sns_pup_linac.xml     - design of SNS linac with all SCL cavities up to
                        SCL:32d, but BPM position are shifted to position of
                        the pickup electrodes according to the file 
                        bpm_pickup_offsets_from_center.dat
